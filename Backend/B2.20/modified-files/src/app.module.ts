...
@Module({
  imports: [
    ...
    ApiModule,
    HealthModule,
    // B2.20: shared platform layer (module/feature registry, discovery,
    // configuration validation, startup verification, platform metadata).
    // Placed after HealthModule since PlatformModule imports it.
    PlatformModule,
  ],
