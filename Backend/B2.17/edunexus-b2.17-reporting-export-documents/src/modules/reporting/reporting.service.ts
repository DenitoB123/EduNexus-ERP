...
import { IReportService } from '../../common/interfaces/reporting-framework.interfaces';
...
export class ReportingService
  implements IReportService<GenerateReportDto, ReportExecutionModel, ReportExecutionQueryDto>
{
  constructor(
