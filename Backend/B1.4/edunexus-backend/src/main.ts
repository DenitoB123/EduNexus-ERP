...
import { ResponseInterceptor } from './modules/response/response.interceptor';
import { GlobalErrorFilter } from './modules/response/error.filter';
...
async function bootstrap(): Promise<void> {
  ...
  // GlobalErrorFilter (1.4) sits outermost for standard { success: false } envelope
